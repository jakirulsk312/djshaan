                ...
                <div className="text-center py-16">
                  <Card className="max-w-md mx-auto bg-card/30 backdrop-blur-sm border-red-300/50">
                    <CardContent className="p-8">
                      ...
                      <h3 className="text-xl font-semibold mb-4 text-red-400">Oops! Something went wrong</h3>
                      <p className="text-red-300 mb-4">{error}</p>
                      <Button
                        onClick={() => window.location.reload()}
                        variant="outline"
                        className="border-red-300/50 text-red-300 hover:bg-red-50/10 bg-card/30 backdrop-blur-sm"
                      >
                        Try Again
                      </Button>
                    </CardContent>
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    {currentVideos.map((video, index) => (
                      <Card
                        key={video._id}
                        className="group cursor-pointer border-primary/20 bg-card/30 backdrop-blur-sm hover:border-primary/50 transition-all duration-300 hover:scale-105 animate-float"
                        style={{ animationDelay: `${index * 0.1}s` }}
                        onClick={() => handleVideoClick(video.link)}
                      >
                        <CardContent className="p-0">
                  ...
                  {totalPages > 1 && (
                    <div className="flex justify-center items-center mt-12 space-x-2">
                      <Button
                        ...
                        disabled={currentPage === 1}
                        variant="outline"
                        className="bg-card/30 backdrop-blur-sm border-primary/20 hover:bg-primary/10"
                      >
                        Previous
                      </Button>
                          ...
                          <Button
                            ...
                            className={
                              currentPage === page 
                                ...
                                : "bg-card/30 backdrop-blur-sm border-primary/20 hover:bg-primary/10"
                            }
                          >
                            {page}
                          </Button>
